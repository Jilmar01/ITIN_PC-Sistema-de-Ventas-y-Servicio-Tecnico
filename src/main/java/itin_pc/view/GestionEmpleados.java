...
public class GestionEmpleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblResumen1.setText("Registrar Nuevo Empleado");
        ...
        txtPuesto.setFont(new java.awt.Font("JetBrains Mono SemiBold", 0, 14)); // NOI18N
        txtPuesto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rol...", "VENDEDOR", "TECNICO", "ADMIN" }));
        txtPuesto.setBorder(null);
        panelRound1.add(txtPuesto, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 0, 280, 40));
        ...
        lblAccesos.setText("Lista de empleados Activos");
        ...
        btnReportes.setText("Reporte Empleados");
        ...
        pnlListaEmpleados.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 80, 140, 40));
        ...
        cmbFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Filtrar por rol...", "VENDEDOR", "TECNICO", "ADMIN" }));
        ...
        panelRound2.add(cmbFiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 0, 200, 40));

        pnlListaEmpleados.add(panelRound2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 210, 40));
        ...
        panelRound5.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 180, 40));

        pnlListaEmpleados.add(panelRound5, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 80, 200, 40));
        ...
        pnlListaEmpleados.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 690, 280));
    ...
    private void agregarUsuario() {
        ...
        String rol = (String) txtPuesto.getSelectedItem();

        Empleado empleado = new Empleado(nombre, apellido, cargo, new Date());

        try {
            int empleadoID = e.agregarEmpleado(empleado);

            Usuario usuario = u.generarNombreUsuario(nombre, apellido, rol);
            usuario.setEmpleadoId(empleadoID);

            int usuarioId = u.agregarUsuario(usuario);

            if (usuarioId > 0) {
                JOptionPane.showMessageDialog(this, "Empleado registrado con exito\nUsuario: " + usuario.getNombreUsuario() + "\nClave: " + usuario.getClaveAcceso());
            }
    ...
    private void aplicarFiltros() {
        ...
        String filtroNombre = txtBuscar.getText().trim();
        String filtroRol = (String) cmbFiltro.getSelectedItem();

        if (filtroNombre.equals("Buscar por nombre...") || filtroNombre.isEmpty()) {
            filtroNombre = "";
        }

        if (filtroRol.equals("Filtrar por rol...")) {
            filtroRol = "";
        }

        try {
            if (!filtroNombre.isEmpty()) {
                listaEmpleados = e.buscarEmpleadoPorNombre(filtroNombre);
            } else if (!filtroRol.isEmpty()) {
                listaEmpleados = e.obtenerEmpleadosPorRol(filtroRol);
            } else {
    ...
    private void verTodosLosEmpleados() {
        try {
            this.listaEmpleados = e.obtenerEmpleados();
    ...
    private void propiedadTabla() {
        ...
        String[] columnas = {"ID", "Nombre Completo", "Rol", "Fecha Ingreso", "Acciones"};
        ...
        tblEmpleados.setFont(new java.awt.Font("JetBrains Mono SemiBoldd", 0, 12));
        tblEmpleados.getTableHeader().setFont(new java.awt.Font("JetBrains Mono ExtraBold", 1, 12));
        tblEmpleados.getTableHeader().setBackground(new Color(4, 178, 234));
        tblEmpleados.getTableHeader().setForeground(Color.white);
        tblEmpleados.getTableHeader().setPreferredSize(new Dimension(100, 36));

        jScrollPane1.setViewportView(tblEmpleados);

        // Configurar el ancho de las columnas
        if (tblEmpleados.getColumnModel().getColumnCount() > 0) {
            tblEmpleados.getColumnModel().getColumn(0).setPreferredWidth(30);
            tblEmpleados.getColumnModel().getColumn(1).setPreferredWidth(100);
            tblEmpleados.getColumnModel().getColumn(2).setPreferredWidth(50);
            tblEmpleados.getColumnModel().getColumn(3).setPreferredWidth(80);
            tblEmpleados.getColumnModel().getColumn(4).setPreferredWidth(120);
        }

        // Agregar renderer personalizado para la columna de rol
        tblEmpleados.getColumnModel().getColumn(2).setCellRenderer(new RolCellRenderer());

        // Agregar renderer y editor personalizado para la columna de acciones
        tblEmpleados.getColumnModel().getColumn(4).setCellRenderer(new AccionesCellRenderer());
        tblEmpleados.getColumnModel().getColumn(4).setCellEditor(new AccionesCellEditor());
