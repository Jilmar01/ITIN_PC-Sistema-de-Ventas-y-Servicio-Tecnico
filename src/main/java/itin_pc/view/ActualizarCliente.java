...
public class ActualizarCliente extends javax.swing.JFrame {
    ...
    public ActualizarCliente(int clienteId) {
    ...
    private void initComponents() {
        ...
        btnActualizar = new jilmar.LabelRound();
        ...
        jLabel3.setText("Gestion de Cliente");
        ...
        lblResumen1.setText("Actualizar Cliente");
        ...
        btnActualizar.setFont(new java.awt.Font("JetBrains Mono NL SemiBold", 0, 14)); // NOI18N
        btnActualizar.setRoundBottomLeft(40);
        btnActualizar.setRoundBottomRight(40);
        btnActualizar.setRoundTopLeft(40);
        btnActualizar.setRoundTopRight(40);
        btnActualizar.setGradientHorizontal(new Color(4, 178, 234), new Color(2, 114, 185));
        ...
        btnActualizar.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                ...
                btnActualizar.setGradientHorizontal(new Color(4, 178, 234), new Color(4, 178, 234));
            }
        ...
        pnlRegistroEmpleado.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 460, 140, 40));
    ...
    private void actualizarEmpleado() {
        ...
        int tipoClienteId = ((TipoCliente) cmbTipoCliente.getSelectedItem()).getId();
        ...
        clienteActualizar.setTipoClienteId(tipoClienteId);

        try {
            boolean clienteActualizado = c.actualizarCliente(clienteActualizar);
    ...
    private void verDatosEmpleado() {
        try {
            this.clienteActualizar = c.obtenerClientePorId(clienteId);

            txtNombre.setText(clienteActualizar.getNombre());
            txtApellido.setText(clienteActualizar.getApellido());
            txtEmail.setText(clienteActualizar.getCorreo());
            txtTelefono.setText(clienteActualizar.getTelefono());
            TipoCliente tipoCliente = c.obtenerTipoClientePorId(clienteId);
    ...
    private jilmar.LabelRound btnActualizar;
