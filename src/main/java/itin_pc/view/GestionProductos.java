...
public class GestionProductos extends javax.swing.JFrame {
    ...
    List<Producto> listaProductosFiltrados;
    ...
    private void aplicarComboBox() {
        try {
            ...
            cmbFiltroCategorias.removeAllItems();
            cmbFiltroCategorias.addItem(new Categoria(0, "Categorías"));

            for (Categoria categoria : categorias) {
                cmbCategorias.addItem(categoria);
                cmbFiltroCategorias.addItem(categoria);
            }
            ...
            cmbFiltroMarcas.removeAllItems();
            cmbFiltroMarcas.addItem(new Marca(0, "Marcas"));

            for (Marca marca : marcas) {
                cmbMarcas.addItem(marca);
                cmbFiltroMarcas.addItem(marca);
            }
    ...
    private void initComponents() {
        ...
        pnlFiltroCategorias = new jilmar.PanelRound();
        cmbFiltroCategorias = new javax.swing.JComboBox<>();
        pnlFiltroMarcas = new jilmar.PanelRound();
        cmbFiltroMarcas = new javax.swing.JComboBox<>();
        ...
        cmbFiltro.setFont(new java.awt.Font("JetBrains Mono SemiBold", 0, 14)); // NOI18N
        cmbFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Filtrar por...", "Categoria", "Marca" }));
        ...
        panelRound2.add(cmbFiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 0, 150, 40));

        pnlListaEmpleados.add(panelRound2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 160, 40));

        pnlFiltroCategorias.setBackground(new java.awt.Color(255, 255, 255));
        pnlFiltroCategorias.setRoundBottomLeft(15);
        pnlFiltroCategorias.setRoundBottomRight(15);
        pnlFiltroCategorias.setRoundTopLeft(15);
        pnlFiltroCategorias.setRoundTopRight(15);
        pnlFiltroCategorias.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        cmbFiltroCategorias.setFont(new java.awt.Font("JetBrains Mono SemiBold", 0, 14)); // NOI18N
        cmbFiltroCategorias.setBorder(null);
        cmbFiltroCategorias.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cmbFiltroCategoriasMouseClicked(evt);
            }
        });
        cmbFiltroCategorias.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbFiltroCategoriasActionPerformed(evt);
            }
        });
        pnlFiltroCategorias.add(cmbFiltroCategorias, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 0, 150, 40));

        pnlFiltroCategorias.setVisible(false);

        pnlListaEmpleados.add(pnlFiltroCategorias, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 70, 160, 40));

        pnlFiltroMarcas.setBackground(new java.awt.Color(255, 255, 255));
        pnlFiltroMarcas.setRoundBottomLeft(15);
        pnlFiltroMarcas.setRoundBottomRight(15);
        pnlFiltroMarcas.setRoundTopLeft(15);
        pnlFiltroMarcas.setRoundTopRight(15);
        pnlFiltroMarcas.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        cmbFiltroMarcas.setFont(new java.awt.Font("JetBrains Mono SemiBold", 0, 14)); // NOI18N
        cmbFiltroMarcas.setBorder(null);
        cmbFiltroMarcas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cmbFiltroMarcasMouseClicked(evt);
            }
        });
        cmbFiltroMarcas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbFiltroMarcasActionPerformed(evt);
            }
        });
        pnlFiltroMarcas.add(cmbFiltroMarcas, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 0, 150, 40));

        pnlFiltroMarcas.setVisible(false);

        pnlListaEmpleados.add(pnlFiltroMarcas, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 70, 160, 40));
    ...
    private void cmbFiltroCategoriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbFiltroCategoriasActionPerformed
        if (!bandera)
            aplicarFiltros();
    }//GEN-LAST:event_cmbFiltroCategoriasActionPerformed

    private void cmbFiltroMarcasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbFiltroMarcasActionPerformed
        if (!bandera)
            aplicarFiltros();
    }//GEN-LAST:event_cmbFiltroMarcasActionPerformed
    ...
    private void cmbFiltroCategoriasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbFiltroCategoriasMouseClicked
        reiniciarFiltros();
    }//GEN-LAST:event_cmbFiltroCategoriasMouseClicked

    private void cmbFiltroMarcasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbFiltroMarcasMouseClicked
        reiniciarFiltros();
    }//GEN-LAST:event_cmbFiltroMarcasMouseClicked
    ...
    private void agregarProducto() {
        ...
        Producto producto = new Producto(nombre, descripcion, precio, marcaId, categoriaId);

        try {

            p.agregarProducto(producto, stock);
    ...
    private void actualizarTabla() {
        ...
        for (Producto producto : listaProductosFiltrados) {
            Object[] fila = {
                producto.getId(),
                producto.getNombre(),
                obtenerMarca(producto.getMarcaId()),
                obtenerCategoria(producto.getCategoriaId()),
                (Object) producto.getPrecio()
            };
    ...
    private javax.swing.JComboBox<Categoria> cmbFiltroCategorias;
    private javax.swing.JComboBox<Marca> cmbFiltroMarcas;
    ...
    private jilmar.PanelRound pnlFiltroCategorias;
    private jilmar.PanelRound pnlFiltroMarcas;
    ...
    private void propiedadTabla() {
        ...
        String[] columnas = {"ID", "Nombre", "Marca", "Categoria", "Precio", "Acciones"};
