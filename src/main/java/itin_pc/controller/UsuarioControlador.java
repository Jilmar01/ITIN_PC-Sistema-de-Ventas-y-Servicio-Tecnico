...
public class UsuarioControlador {
     ...
     * @throws Excepciones si hay un error al agregar el usuario o si los datos son inválidos
     */
     ...
     * @return Usuario objeto con el nombre de usuario, contraseña generados y rol asignado.
     */
